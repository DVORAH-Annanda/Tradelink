...
namespace Spinning {
    ...
    public class YarnSOHByTex : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Spinning.YarnSOHByTex.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedYarnSOHByTex : Component, ICachedReport {
        
        public CachedYarnSOHByTex() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            YarnSOHByTex rpt = new YarnSOHByTex();
            rpt.Site = this.Site;
            return rpt;
        }
