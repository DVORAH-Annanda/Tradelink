...
namespace DyeHouse
{
    public partial class frmRejectFabric : Form
    {
        bool formloaded;
        Util core;
        List<DATA> fieldSelected = null;

        public frmRejectFabric()
        {
            InitializeComponent();
            core = new Util();
            SetUp();
        ...
        private void frmRejectFabric_Load(object sender, EventArgs e)
        {
            ...
            if (oBtn != null && formloaded)
            {
                ...
                using (var context = new TTI2Entities())
                {
                    ...
                    if (AddRec)
                    {
                        ...
                        tt.TLDYET_TransactionNumber = "RF" + LNU.col7.ToString().PadLeft(6,'0');
                        ...
                        try
                        {
                            ...
                            frmDyeViewReport vRep = new frmDyeViewReport(11, tt.TLDYET_Pk);
