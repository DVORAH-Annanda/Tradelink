...
namespace DyeHouse {
    ...
    public class NCRReport : ReportClass {
    ...
    public class CachedNCRReport : Component, ICachedReport {
        
        public CachedNCRReport() {
        }
