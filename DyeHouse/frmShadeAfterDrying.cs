...
namespace DyeHouse
{
    public partial class frmShadeAfterDrying : Form
    {
        DyeReportOptions repOps = null;
        bool formloaded; 

        public frmShadeAfterDrying()
        {
            InitializeComponent();
        }

        private void frmShadeAfterDrying_Load(object sender, EventArgs e)
        {
            ...
            reportOptions.Add(new KeyValuePair<string, string>("5", "Measured fabric weight"));
            reportOptions.Add(new KeyValuePair<string, string>("6", "Measured length shrinkage(large to small)"));
            reportOptions.Add(new KeyValuePair<string, string>("7", "Measured width shrinkage(large to small)"));
            reportOptions.Add(new KeyValuePair<string, string>("8", "Result Type"));
            reportOptions.Add(new KeyValuePair<string, string>("9", "By cause when not complying"));
            reportOptions.Add(new KeyValuePair<string, string>("10", "By remedy where not compliant"));
