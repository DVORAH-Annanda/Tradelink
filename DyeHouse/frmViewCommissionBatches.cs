...
namespace DyeHouse
{
    public partial class frmViewCommissionBatches : Form
    {
        bool FormLoaded;
        DyeRepository repo;
        ...
        public frmViewCommissionBatches()
        {
            InitializeComponent();
        ...
        private void frmViewCommissionBatches_Load(object sender, EventArgs e)
        {
            FormLoaded = false;
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (oBtn != null && FormLoaded)
            {
                ...
                var DyeBatches = repo.SelectCommissionDyeBatches(DyeParameters);
