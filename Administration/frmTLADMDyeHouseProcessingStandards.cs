...
namespace TTI2_WF
{
    public partial class frmTLADMDyeHouseProcessingStandards : Form
    {
        /*
        ...
        DataGridViewTextBoxColumn processingStandardIndex;     // 0 
        DataGridViewButtonColumn  fabricSize;                  // 1 
        DataGridViewTextBoxColumn hydroFrame;                  // 2
        DataGridViewTextBoxColumn hydroPadding;                // 3 
        DataGridViewTextBoxColumn hydroOFeed;                  // 4
        DataGridViewButtonColumn  hydroWidthAfter;             // 5
        DataGridViewTextBoxColumn hydroWidthBefore;            // 6
        DataGridViewTextBoxColumn drierWidthBefore;            // 7
        DataGridViewTextBoxColumn drierSpeed;                  // 8
        DataGridViewTextBoxColumn drierWidthAfter;             // 9
        DataGridViewTextBoxColumn calenderWidthBefore;         // 10
        DataGridViewTextBoxColumn calenderSpeed;               // 11
        ...
        public frmTLADMDyeHouseProcessingStandards(int CoNum)
        {
            InitializeComponent();
            core = new Util();
            ...
            column.ColumnName = "FabricSize_Pk";
            column.Caption = "Size";
            ...
            column = new DataColumn();
            column.DataType = typeof(Int32);
            column.ColumnName = "HydroWidthBefore_Pk";
            column.Caption = "Width Before";
            column.DefaultValue = 0;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(string);
            column.ColumnName = "Frame_Pk";
            column.Caption = "Frame";
            column.DefaultValue = string.Empty;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(decimal);
            column.ColumnName = "OFeed_Pk";
            column.Caption = "O/Feed";
            column.DefaultValue = 0.0M;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(Int32);
            column.ColumnName = "HydroWidthAfter_Pk";
            column.Caption = "Width After";
            column.DefaultValue = 0;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(Int32);
            column.ColumnName = "DrierWidthBefore_Pk";
            column.Caption = "Width Before";
            column.DefaultValue = 0;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(Int32);
            column.ColumnName = "DrierSpeed";
            column.Caption = "Speed";
            column.DefaultValue =  0;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(Int32);
            column.ColumnName = "DrierWidthAfter";
            column.Caption = "Width After";
            column.DefaultValue = 0;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(Int32);
            column.ColumnName = "CalenderWidthBefore";
            column.Caption = "Width before";
            column.DefaultValue = 0;
            ProductRating.Columns.Add(column);
            ...
            column = new DataColumn();
            column.DataType = typeof(Int32);
            column.ColumnName = "CalenderWeightBefore";
            column.Caption = "Weight Before";
            column.DefaultValue = 0;
            ProductRating.Columns.Add(column);

            //0 -- index of record 
            //--------------------------------------------
            processingStandardIndex = new DataGridViewTextBoxColumn();
            processingStandardIndex.Name = "PrRatingIndex";
            processingStandardIndex.ValueType = typeof(Int32);
            processingStandardIndex.DataPropertyName = ProductRating.Columns[0].ColumnName;
            processingStandardIndex.HeaderText = "Rating Index"; 
            dataGridView1.Columns.Add(processingStandardIndex);
            dataGridView1.Columns["PrRatingIndex"].DisplayIndex= 0;


            //1 -- Size Button 
            //--------------------------------------------
            fabricSize = new DataGridViewButtonColumn();
            fabricSize.Name = "SizeButton";
            fabricSize.ValueType = typeof(string);
            fabricSize.HeaderText = "Sizes";
            fabricSize.DataPropertyName= ProductRating.Columns[1].ColumnName;
            dataGridView1.Columns.Add(fabricSize);
            ...
            //2 -- hydroWidthBefore
            //----------------------------------------------
            hydroWidthBefore = new DataGridViewTextBoxColumn();
            hydroWidthBefore.Name = "FabWidth";
            hydroWidthBefore.ValueType = typeof(Int32);
            hydroWidthBefore.DataPropertyName = ProductRating.Columns[2].ColumnName;
            hydroWidthBefore.HeaderText = "Fabric Width";
            dataGridView1.Columns.Add(hydroWidthBefore);
            dataGridView1.Columns["FabWidth"].DisplayIndex = 2;

            //3 -- hydroFrame
            //----------------------------------------------
            hydroFrame = new DataGridViewTextBoxColumn();
            hydroFrame.Name = "Frame";
            hydroFrame.HeaderText = "Frame";
            hydroFrame.ValueType = typeof(decimal);
            hydroFrame.DataPropertyName = ProductRating.Columns[3].ColumnName;
            dataGridView1.Columns.Add(hydroFrame);
            dataGridView1.Columns["Frame"].DisplayIndex = 3;

            //4 -- hydroPadding
            //-------------------------------------------------
            hydroPadding = new DataGridViewTextBoxColumn();
            hydroPadding.Name = "MarkerLength";
            hydroPadding.HeaderText = "Marker Length";
            hydroPadding.ValueType = typeof(decimal);
            hydroPadding.DataPropertyName = ProductRating.Columns[4].ColumnName;
            dataGridView1.Columns.Add(hydroPadding);
            dataGridView1.Columns["MarkerLength"].DisplayIndex = 4;

            //5 -- hydroOFeed
            //--------------------------------------------------------
            hydroOFeed = new DataGridViewTextBoxColumn();
            hydroOFeed.Name = "Ratings";
            hydroOFeed.HeaderText = "Rating's";
            hydroOFeed.ValueType = typeof(decimal);
            hydroOFeed.DataPropertyName = ProductRating.Columns[5].ColumnName;
            dataGridView1.Columns.Add(hydroOFeed);
            dataGridView1.Columns["Ratings"].DisplayIndex = 5;

            //6 -- hydroWidthAfter
            //--------------------------------------------------------
            hydroWidthAfter = new DataGridViewButtonColumn();
            hydroWidthAfter.Name = "HydroWidthAfter";
            hydroWidthAfter.HeaderText = "Hydro Width After";
            hydroWidthAfter.ValueType = typeof(Int32);
            hydroWidthAfter.DataPropertyName = ProductRating.Columns[6].ColumnName;
            dataGridView1.Columns.Add(hydroWidthAfter);
            dataGridView1.Columns["HydroWidthAfter"].DisplayIndex = 6;

            //7 drierWidthBefore 
            //----------------------------------------------
            drierWidthBefore = new DataGridViewTextBoxColumn();
            drierWidthBefore.Name = "Multi_Marker_Pk";
            drierWidthBefore.HeaderText = "MultiMarker";
            drierWidthBefore.ValueType = typeof(Boolean);
            drierWidthBefore.DataPropertyName = ProductRating.Columns[7].ColumnName;
            dataGridView1.Columns.Add(drierWidthBefore);
            dataGridView1.Columns["Multi_Marker_Pk"].DisplayIndex = 7;

            //8 drierSpeed
            //----------------------------------------------
            drierSpeed = new DataGridViewTextBoxColumn();
            drierSpeed.Name = "SizesPN_Pk";
            drierSpeed.HeaderText = "SizesPN";
            drierSpeed.ValueType = typeof(Int32);
            drierSpeed.DataPropertyName = ProductRating.Columns[8].ColumnName;
            dataGridView1.Columns.Add(drierSpeed);
            dataGridView1.Columns["SizesPN_Pk"].DisplayIndex = 8;

            //9 drierWidthAfter
            //----------------------------------------------
            drierWidthAfter = new DataGridViewTextBoxColumn();
            drierWidthAfter.Name = "NewRecord_Pk";
            drierWidthAfter.HeaderText = "NewRecord";
            drierWidthAfter.ValueType = typeof(bool);
            drierWidthAfter.DataPropertyName = ProductRating.Columns[9].ColumnName;
            dataGridView1.Columns.Add(drierWidthAfter);
            dataGridView1.Columns["NewRecord_Pk"].DisplayIndex = 9;

            //10 calenderWidthBefore 
            //----------------------------------------------
            calenderWidthBefore = new DataGridViewTextBoxColumn();
            calenderWidthBefore.Name = "Sizes_Pk";
            calenderWidthBefore.HeaderText = "Sizes_Pk";
            calenderWidthBefore.ValueType = typeof(Int32);
            calenderWidthBefore.DataPropertyName = ProductRating.Columns[10].ColumnName;
            dataGridView1.Columns.Add(calenderWidthBefore);
            dataGridView1.Columns["Sizes_Pk"].DisplayIndex = 10;

            //11 calenderSpeed 
            //----------------------------------------------
            calenderSpeed = new DataGridViewTextBoxColumn();
            calenderSpeed.Name = "CalenderSpeed";
            calenderSpeed.HeaderText = "Speed";
            calenderSpeed.ValueType = typeof(Int32);
            calenderSpeed.DataPropertyName = ProductRating.Columns[11].ColumnName;
            dataGridView1.Columns.Add(calenderSpeed);
        ...
        private void frmTLADMDyeHouseProcessingStandards_Load(object sender, EventArgs e)
        {
            formloaded = false;
            ...
            if (oDgv.Focused && oDgv.CurrentCell is DataGridViewButtonCell)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //frmTLADMDyeHouseProcessingStandardsDetail prodDetail = new frmTLADMDyeHouseProcessingStandardsDetail(PNumber, PrimaryKey);
