...
namespace Knitting
{
    public partial class frmCommKnitting : Form
    {
        bool formloaded;
        ...
        void SetUp()
        {
            ...
            this.Text = "Receipt of yarn for commission knitting";

            MandFieldsSelected = core.PopulateArray(MandatoryFields.Length, false);

            using (var context = new TTI2Entities())
            {
                cmbCommissionCustomers.DataSource = context.TLADM_CustomerFile.Where(x=>x.Cust_CommissionCust).OrderBy(x => x.Cust_Description).ToList();
        ...
        private void frmCommKnitting_Load(object sender, EventArgs e)
        {
        ...
        private void txtCustomerDoc_TextChanged(object sender, EventArgs e)
        {
                ...
                using (var context = new TTI2Entities())
                {
                    ...
                    try
                    {
                        ...
                        foreach (DataGridViewRow dr in dataGridView1.Rows)
                        {
                            ...
                            PalletStore.TLKNIOP_CommissionCustomer_FK = CommissionCust.Cust_Pk;
